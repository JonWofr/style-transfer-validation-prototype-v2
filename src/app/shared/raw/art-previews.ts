...
export const artPreviews: StyleImage[] = [
  {
    id: '669611e3d06fc96e',
    publicUrl: '/assets/images/art-preview/abstract/kitty_composition-vii.jpg',
    name: 'Abstract',
    description:
      "The Abstract style turns your pet's picture into a colorful painting with big strokes.",
    mockupUrls: [
  ...
  },
  {
    ...
    name: 'Newspaper',
    description:
      'Modern and unique. The Newspaper style creates a stunning artwork with subtle letters shimmering through the strokes of paint.',
    mockupUrls: [
  ...
  },
  {
    ...
    name: 'Watercolor',
    description:
      'The watercolor art-style emphasizes your pet with solid strokes while keeping the background neutral with sprinkles of paint here and there.',
    mockupUrls: [
